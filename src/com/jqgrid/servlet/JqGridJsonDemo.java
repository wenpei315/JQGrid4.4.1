...
public class JqGridJsonDemo extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		}else if("getLeftTree".equalsIgnoreCase(method)){
			jsonStr = "<?xml version='1.0' encoding='utf-8'?>" +
					"<rows>" +
					"<page>1</page>" +
					"<total>1</total>" +
					"<records>1</records>" +
				    ...
				    "<row><cell>4</cell><cell>Load once</cell><cell>loadoncex.html</cell><cell>1</cell><cell>6</cell><cell>7</cell><cell>true</cell><cell>true</cell></row>"+
				    "<row><cell>5</cell><cell>Array Data</cell><cell>localex.html</cell><cell>1</cell><cell>8</cell><cell>9</cell><cell>true</cell><cell>true</cell></row>"+
